...
import openmarker.tea.parsetree.AndExpression;
import openmarker.tea.parsetree.ArithmeticExpression;
import openmarker.tea.parsetree.ArrayLookup;
import openmarker.tea.parsetree.AssignmentStatement;
import openmarker.tea.parsetree.Block;
import openmarker.tea.parsetree.BooleanLiteral;
import openmarker.tea.parsetree.BreakStatement;
import openmarker.tea.parsetree.CallExpression;
import openmarker.tea.parsetree.CompareExpression;
import openmarker.tea.parsetree.ConcatenateExpression;
import openmarker.tea.parsetree.ContinueStatement;
import openmarker.tea.parsetree.ExceptionGuardStatement;
import openmarker.tea.parsetree.Expression;
import openmarker.tea.parsetree.ExpressionList;
import openmarker.tea.parsetree.ExpressionStatement;
import openmarker.tea.parsetree.ForeachStatement;
import openmarker.tea.parsetree.FunctionCallExpression;
import openmarker.tea.parsetree.IfStatement;
import openmarker.tea.parsetree.ImportDirective;
import openmarker.tea.parsetree.Logical;
import openmarker.tea.parsetree.Lookup;
import openmarker.tea.parsetree.Name;
import openmarker.tea.parsetree.NegateExpression;
import openmarker.tea.parsetree.NewArrayExpression;
import openmarker.tea.parsetree.NoOpExpression;
import openmarker.tea.parsetree.Node;
import openmarker.tea.parsetree.NodeVisitor;
import openmarker.tea.parsetree.NotExpression;
import openmarker.tea.parsetree.NullLiteral;
import openmarker.tea.parsetree.NullSafe;
import openmarker.tea.parsetree.NumberLiteral;
import openmarker.tea.parsetree.OrExpression;
import openmarker.tea.parsetree.ParenExpression;
import openmarker.tea.parsetree.RelationalExpression;
import openmarker.tea.parsetree.ReturnStatement;
import openmarker.tea.parsetree.SpreadExpression;
import openmarker.tea.parsetree.Statement;
import openmarker.tea.parsetree.StatementList;
import openmarker.tea.parsetree.StringLiteral;
import openmarker.tea.parsetree.SubstitutionStatement;
import openmarker.tea.parsetree.Template;
import openmarker.tea.parsetree.TemplateCallExpression;
import openmarker.tea.parsetree.TernaryExpression;
import openmarker.tea.parsetree.TreeWalker;
import openmarker.tea.parsetree.TypeExpression;
import openmarker.tea.parsetree.TypeName;
import openmarker.tea.parsetree.Variable;
import openmarker.tea.parsetree.VariableRef;
import openmarker.tea.parsetree.Expression.Conversion;
import openmarker.tea.runtime.Context;
import openmarker.tea.runtime.Substitution;
import openmarker.tea.runtime.SubstitutionId;
import openmarker.tea.runtime.Truthful;
import openmarker.tea.runtime.WrapperTypeConversionUtil;
import openmarker.trove.classfile.ClassFile;
import openmarker.trove.classfile.CodeBuilder;
import openmarker.trove.classfile.Label;
import openmarker.trove.classfile.LocalVariable;
import openmarker.trove.classfile.MethodInfo;
import openmarker.trove.classfile.Modifiers;
import openmarker.trove.classfile.Opcode;
import openmarker.trove.classfile.TypeDesc;
import openmarker.trove.util.MergedClass;
                ...
                if (to.isPrimitive()) {
                    ...
                    if (fromObj == toObj) {
                        if (fromObj == Boolean.class) {
                            ...
                            mBuilder.invokeStatic("openmarker.trove.util.IntegerFactory",
                                                  "toInteger",

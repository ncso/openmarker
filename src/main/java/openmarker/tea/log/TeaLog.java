...
package openmarker.tea.log;

import openmarker.trove.log.Log;
import openmarker.trove.log.LogEvent;
import openmarker.trove.log.LogListener;
 ...
 *  	at openmarker.tea.runtime.TemplateLoader$TemplateImpl.execute(TemplateLoader.java:270)
 *  	at openmarker.tea.engine.TemplateSourceImpl$TemplateImpl.execute(TemplateSourceImpl.java:838)
 ...
 *  	at openmarker.trove.util.tq.TransactionQueue$Worker.run(TransactionQueue.java:671)
 *  	at openmarker.trove.util.ThreadPool$PooledThread.run(ThreadPool.java:676)
 *

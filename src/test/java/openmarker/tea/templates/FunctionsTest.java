...
public class FunctionsTest extends AbstractTemplateTest {
    ...
    protected static final String TEST_STATIC_SOURCE_5 =
    	"openmarker.tea.templates.FunctionsTest.INSTANCE.getFunction().getGreeting()";

    protected static final String TEST_STATIC_SOURCE_6 =
    	"openmarker.tea.templates.FunctionsTest.INSTANCE.function.getGreeting()";

    protected static final String TEST_STATIC_SOURCE_7 =
    	"openmarker.tea.templates.FunctionsTest.INSTANCE.function.greeting";

    protected static final String TEST_STATIC_SOURCE_8 =
    	"openmarker.tea.templates.FunctionsTest.INSTANCE.function.greeting.length";

    protected static final String TEST_STATIC_SOURCE_9 =
    	"openmarker.tea.templates.FunctionsTest$Interface.GREETING";
